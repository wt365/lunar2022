;// lunar2021.js by Tingyu
const lunar2021=function () {
	...
	function MDtoLunar(m,d) {
		const C=[0,31,59,90,120,151,181,212,243,273,304,334], L=[-17,12,42,71,101,131,160,190,219,249,278,308,337], Lx=['冬','腊','正','二','三','四','五','六','七','八','九','十','冬'], n=C[m-1]+d, ly=n>42?'辛丑':'庚子';
		let i=L.length-1;
		while (n<L[i]+1) {i--;}
